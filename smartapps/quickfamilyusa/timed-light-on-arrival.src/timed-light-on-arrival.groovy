 ...
 */
definition(
    name: "Timed light on arrival",
    namespace: "quickfamilyusa",
    author: "Andrew Quick",
    description: "turns light off after X minutes unless light already on. Uses arrival as trigger",
    category: "My Apps",
...
preferences {
	section("Timed Light Control") {
        ...
        // Triggered by presence sensor
        input "presence1", "capability.presenceSensor", title: "What presence sensor?", multiple: true
